...
public class LogEntry {
    ...
    public LogEntry(String Timestamp, String Iface, String MTU, String Met, String RX_OK, String RX_ERR, String RX_DRP, String RX_OVR, String TX_OK, String TX_ERR, String TX_DRP, String TX_OVR, String Flg) {
    ...
    public String toString() {
        return "LogEntry{" + "Timestamp=" + Timestamp + ", Iface=" + Iface + ", MTU=" + MTU + ", Met=" + Met + ", RX_OK=" + RX_OK + ", RX_ERR=" + RX_ERR + ", RX_DRP=" + RX_DRP + ", RX_OVR=" + RX_OVR + ", TX_OK=" + TX_OK + ", TX_ERR=" + TX_ERR + ", TX_DRP=" + TX_DRP + ", TX_OVR=" + TX_OVR + ", Flg=" + Flg + '}';
    }
